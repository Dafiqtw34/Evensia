package com.example.evensia.gedung.pesanan.model;

public class ModelPesanan {
    private String alamat, harga, isi, judul, nilai, gambar1, gambar2, gambar3, gambar4, jam, name, email, nomor, emailuser, tv_date;
